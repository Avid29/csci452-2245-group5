...
**
** Variations:  rcr0(), rcr2(), rcr3(), rcr4(), reflags(),
**              rebp(), resp()
**
...
*/
static inline void
lgdt( void *addr ) OPSINLINED
{
	__asm__ __volatile__( "lgdt (%0)" : : "r" (addr) );
}

static inline void
lidt( void *addr ) OPSINLINED
{
