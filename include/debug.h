...
#define WARNING(m)  do { \
        cio_printf( "WARN %s (%s @ %d): ", __func__, __FILE__, __LINE__ ); \
        cio_puts( m ); \
        cio_putchar( '\n' ); \
    } while(0)
...
#ifdef T_QUE
#define TRQUEUE         0x00004
#else
#define TRQUEUE         0
#endif

#ifdef T_SCH
#define TRSCHED         0x00008
#else
#define TRSCHED         0
#endif

#ifdef T_DSP
#define TRDISP          0x00010
#else
#define TRDISP          0
#endif

#ifdef T_SCALL
#define TRSYSCALLS      0x00020
#else
#define TRSYSCALLS      0
#endif

#ifdef T_SRET
#define TRSYSRETS       0x00040
#else
#define TRSYSRETS       0
#endif

#ifdef T_EXIT
#define TREXIT          0x00080
#else
#define TREXIT          0
#endif

#ifdef T_INIT
#define TRINIT          0x00100
#else
#define TRINIT          0
#endif

#ifdef T_KM
#define TRKMEM          0x00200
#else
#define TRKMEM          0
#endif

#ifdef T_KMFR
#define TRKMEM_F        0x00400
#else
#define TRKMEM_F        0
#endif

#ifdef T_KMIN
#define TRKMEM_I        0x00800
#else
#define TRKMEM_I        0
#endif

#ifdef T_FORK
#define TRFORK          0x01000
#else
#define TRFORK          0
#endif

#ifdef T_EXEC
#define TREXEC          0x02000
#else
#define TREXEC          0
#endif

#ifdef T_SIO
#define TRSIO_STAT      0x04000
#else
#define TRSIO_STAT      0
#endif

#ifdef T_SIOR
#define TRSIO_RD        0x08000
#else
#define TRSIO_RD        0
#endif

#ifdef T_SIOW
#define TRSIO_WR        0x10000
#else
#define TRSIO_WR        0
#endif
